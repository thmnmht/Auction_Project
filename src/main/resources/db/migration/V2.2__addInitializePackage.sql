...
# initial auctions
INSERT INTO Auctions (title, description, base_price, category_id, date, state, owner_id, max_number)
VALUES ("توپ بسکتبال نابی", "دست یه بسکتبالیست حرفه‌ای بوده!", 400000,
        ...
        (SELECT id FROM Users WHERE Users.email = "Alirezadizaji@yahoo.com"), 4);
INSERT INTO Auctions (title, description, base_price, category_id, date, state, owner_id, max_number)
VALUES ("macbook pro نو", "دست یه برنامه نویس حرفه‌ای بوده!", 20000000,
        ...
        (SELECT id FROM Users WHERE Users.email = "seyfanomid@ymail.com"), 6);
INSERT INTO Auctions (title, description, base_price, category_id, date, state, owner_id, max_number)
VALUES ("Apple Watch", "تمیز و بدون خط و خش", 1000000, (SELECT id FROM Categories WHERE Categories.name = "دیجیتال"),
        '2019-04-09 22:00:00', 0, (SELECT id FROM Users WHERE Users.email = "yalda.yarandi@gmail.com"), 5);
INSERT INTO Auctions (title, description, base_price, category_id, date, state, owner_id, max_number)
VALUES ("یخچال سایدبای ساید SNOWA", "با ۱.۵ سال گارانتی اصلی", 12000000,
        ...
        (SELECT id FROM Users WHERE Users.email = "tmohati@gmail.com"), 3);
INSERT INTO Auctions (title, description, base_price, category_id, date, state, owner_id, max_number)
VALUES ("لپتاپ ایسوز FX502VM", "سالم و اصل", 16000000,
        ...
        (SELECT id FROM Users WHERE Users.email = "sobhanebrahimi82@gmail.com"), 4);
INSERT INTO Auctions (title, description, base_price, category_id, date, state, owner_id, max_number)
VALUES ("کولر گازی LG", "تورو خدا بخرید یخ کردیم تو رهنماکالج", 7000000,
        ...
        (SELECT id FROM Users WHERE Users.email = "sobhanebrahimi82@gmail.com"), 5);
INSERT INTO Auctions (title, description, base_price, category_id, date, state, owner_id, max_number)
VALUES ("صندلی های بدون چرخ رهنماکالج", "پدر کمرامون دراومده", 100000,
        ...
        (SELECT id FROM Users WHERE Users.email = "seyfanomid@ymail.com"), 4);
INSERT INTO Auctions (title, description, base_price, category_id, date, state, owner_id, max_number)
VALUES ("اجاق گاز رهنماکالج", "اصلا استفاده نشده و سالم و تمیزه", 2000000,
        ...
        (SELECT id FROM Users WHERE Users.email = "yalda.yarandi@gmail.com"), 8);
INSERT INTO Auctions (title, description, base_price, category_id, date, state, owner_id, max_number)
VALUES ("ست لباس ورزشی", "هدیه گرفتم تا حالا نپوشیدم", 200000,
        ...
        (SELECT id FROM Users WHERE Users.email = "tmohati@gmail.com"), 11);
